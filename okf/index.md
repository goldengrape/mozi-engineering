...
The project is at the **RMD-GIT-001 merge checkpoint**. RMD-TASK-001 is implemented and tested; PR #3 is unmerged.
...
RMD-0001 is accepted. RMD-TASK-001 passed its automated checks; RMD-TASK-002 remains blocked by the PR #3 merge checkpoint.
